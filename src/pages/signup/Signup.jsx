...
const handleOnSubmit = async (e) => {
    ...
    try {
        ...
        console.log('created user as : ', Response.newUserResponse)
        setError(true)
    }
}
        ...
        <form onSubmit={handleOnSubmit}>
          <div className="mb-3">
            <input
              ...
              onChange={(e)=>  setUserInput({...userInputs, full_name: e.target.value})}
          ...
          <div className="mb-3">
            <input
              ...
              id="email"
              placeholder="email..."
              onChange={(e)=>  setUserInput({...userInputs, email: e.target.value})}
              value={userInputs.email}
            />
          </div>
          {
            error ? (<><p className="text-center text-danger">Something wrong happenned! Try again!</p></>) : (<></>)
          }
